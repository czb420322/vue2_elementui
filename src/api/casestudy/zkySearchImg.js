 ...
 * @LastEditTime : 2020-12-29 10:51:50
        ...
        zkyImgPicWh() {
            ...
            this.$http.post("/vsas/structure/recImage", data).then(reponse => {
                if (reponse.data.code == 200) {
                    ...
                    if (this.recodeResult.Result[0].Vehicles.length == 0 && this.recodeResult.Result[0].Pedestrian.length == 0 && this.recodeResult.Result[0].NonMotorVehicles.length == 0) {
                        this.$notify({
                            type: "warning",
                            message: "图片识别失败",
