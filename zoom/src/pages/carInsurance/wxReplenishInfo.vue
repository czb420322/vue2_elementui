    ...
    <ol class="content" :style="{ 'margin-top': ($iosSystem + 46) + 'px' }">
      <li class="list">
        <div class="info-box">
          ...
          <van-field v-if="this.vehicleType == '1'" label="客户性质" placeholder="请选择客户性质" :value="applyInfoDTO.insuredNature.value.text" @click="applyInfoDTO.checkedOwner ? '' : showInsuredNature(['applyInfoDTO', 'insuredNature', 'value'], applyInfoDTO.insuredNature)" :class="applyInfoDTO.checkedOwner ? 'readonly_cell': ''" :readonly="true" right-icon="arrow" />
          <template v-if="applyInfoDTO.insuredNature.value.value == 3">
            ...
            <van-field :value="applyInfoDTO.idNo" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'idNo' )" :class="applyInfoDTO.checkedOwner ? 'readonly_cell': ''" :readonly="applyInfoDTO.checkedOwner" maxlength="18" label="身份证号码" placeholder="请输入身份证号码" />
            <van-field :value="applyInfoDTO.mobile" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'mobile' )" maxlength="11" oninput="value=value.replace(/[^\d]/g,'')" label="手机号码" placeholder="请输入手机号码" />
            <van-field :value="applyInfoDTO.detailed_address" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'detailed_address' )" label="地址" placeholder="请输入地址" />
          </template>
          <template v-else>
            <van-field :value="applyInfoDTO.name" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'name' )" :class="applyInfoDTO.checkedOwner ? 'readonly_cell': ''" :readonly="applyInfoDTO.checkedOwner" label="投保人" placeholder="请输入投保人" />
            <van-field :value="applyInfoDTO.idNo" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'idNo' )" :class="applyInfoDTO.checkedOwner ? 'readonly_cell': ''" :readonly="applyInfoDTO.checkedOwner" maxlength="18" label="组织机构代码" placeholder="请输入组织机构代码" />
            <van-field :value="applyInfoDTO.detailed_address" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'detailed_address' )" label="联系地址" placeholder="请输入联系地址" />
            <van-field :value="applyInfoDTO.appliLinkerName" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'appliLinkerName' )"  label="联系人姓名" placeholder="请输入联系人姓名" />
            <van-field :value="applyInfoDTO.mobile" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'mobile' )" maxlength="11" oninput="value=value.replace(/[^\d]/g,'')" label="联系人手机" placeholder="请输入联系人手机" />
            <van-field v-if="UserInfo.manageCode == '07000000'" :value="applyInfoDTO.appliLinkmanIdnum" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataApplyInfoDTO', 'appliLinkmanIdnum' )" maxlength="18" label="联系人身份证号码" placeholder="请输入联系人身份证号码" />
          </template>
      ...
      <li class="list">
        <div class="info-box">
          ...
          <template v-else>
            <van-field :value="insureInfoDTO.name" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'name' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" label="被保人" placeholder="请输入被保人" />
            <van-field :value="insureInfoDTO.idNo" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'idNo' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" maxlength="18" label="组织机构代码" placeholder="请输入组织机构代码" />
            <van-field :value="insureInfoDTO.detailed_address" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'detailed_address' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" label="联系地址" placeholder="请输入联系地址" />
            <van-field :value="insureInfoDTO.insuredLinkerName" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'insuredLinkerName' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" label="联系人姓名" placeholder="请输入联系人姓名" />
            <van-field :value="insureInfoDTO.mobile" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'mobile' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" maxlength="11" oninput="value=value.replace(/[^\d]/g,'')" label="联系人手机" placeholder="请输入联系人手机" />
            <van-field v-if="UserInfo.manageCode == '07000000'" :value="insureInfoDTO.insuredLinkmanIdnum" @change="asyncFrom(insureInfoDTO.checkedApplyInfo)" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'insuredLinkmanIdnum' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" maxlength="18" label="联系人身份证号码" placeholder="请输入联系人身份证号码" />
          </template>
          <van-field v-if="UserInfo.manageCode == '07000000'" class="phoneHolderItem" :value="insureInfoDTO.phoneHolderName" @input="updataFrom($event, 'car/updataInsureInfoDTO', 'phoneHolderName' )" :class="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo? 'readonly_cell': ''" :readonly="insureInfoDTO.checkedOwner || insureInfoDTO.checkedApplyInfo" label="手机持有人姓名" placeholder="请输入姓名">
            <template #right-icon>
    ...
    async onSubmit() {
      ...
      if (this.applyInfoDTO.insuredNature.value.value == 3) {
        ...
        if (!this.applyInfoDTO.name) {
          this.$toast('请输入投保人'); this.disabled = false;
          return;
        }
        if (!this.applyInfoDTO.idNo) {
          this.$toast('请输入投保人组织机构代码'); this.disabled = false;
          return;
        }
        if (!this.applyInfoDTO.detailed_address) {
          this.$toast('请输入投保人联系地址'); this.disabled = false;
          return;
        }
        if (!compCheck.isName(this.applyInfoDTO.appliLinkerName, '投保人联系人姓名格式不正确')) {
          this.disabled = false;
          return;
        }
        if (!compCheck.isMobile(this.applyInfoDTO.mobile, '投保人联系人手机号码格式不正确')) {
          this.disabled = false;
          return;
        }
        if (this.UserInfo.manageCode == '07000000') {
          if (!compCheck.isIdno(this.applyInfoDTO.appliLinkmanIdnum, '投保人联系人身份证号码格式不正确')) {
            this.disabled = false;
            return;
          }
        }
      }
      if (this.applyInfoDTO.phoneHolderName && !compCheck.isName(this.applyInfoDTO.phoneHolderName, '投保人手机持有人姓名格式不正确')) {
        this.disabled = false;
        return;
      }
      ...
      if (this.insureInfoDTO.insuredNature.value.value == 3) {
        ...
        if (!this.insureInfoDTO.name) {
          this.$toast('请输入保人'); this.disabled = false;
          return;
        }
        if (!this.insureInfoDTO.idNo) {
          this.$toast('请输入被保人组织机构代码'); this.disabled = false;
          return;
        }
        if (!this.insureInfoDTO.detailed_address) {
          this.$toast('请输入被保人联系地址'); this.disabled = false;
          return;
        }
        if (!compCheck.isName(this.insureInfoDTO.insuredLinkerName, '被保人联系人姓名格式不正确')) {
          this.disabled = false;
          return;
        }
        if (!compCheck.isMobile(this.insureInfoDTO.mobile, '被保人联系人手机号码格式不正确')) {
          this.disabled = false;
          return;
        }
        if (this.UserInfo.manageCode == '07000000') {
          if (!compCheck.isIdno(this.insureInfoDTO.insuredLinkmanIdnum, '被保人联系人身份证号码格式不正确')) {
            this.disabled = false;
            return;
          }
        }
      }
      if (this.insureInfoDTO.phoneHolderName && !compCheck.isName(this.insureInfoDTO.phoneHolderName, '被保人手机持有人姓名格式不正确')) {
        this.disabled = false;
        return;
      }
      ...
      if (this.vehicleType == '1') {
        ...
        if (this.applyInfoDTO.insuredNature.value.value == '4') {
          params.applyInfoDTO.idType = '12'
        }
        if (this.insureInfoDTO.insuredNature.value.value == '4') {
          params.insureInfoDTO.idType = '12'
        }
      }
