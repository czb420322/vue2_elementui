...
define(function () {
    var paper = {
        ...
        drawPaper: function(font){
        	
            this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
        	
        	this.drawFont(font, this.canvas.width, this.canvas.height);
        ...
        drawFont: function(font, width, height){
        	if(font){
        		this.context.save();//保存当前的context状态（快照，用于恢复，防止状态设置紊乱污染）
            	// 设置字体
            	this.context.font = "10rem bold 宋体";
            	// 设置颜色
            	this.context.fillStyle = "#a29e9e";
            	// 设置水平对齐方式
            	this.context.textAlign = "center";
            	// 设置垂直对齐方式
            	this.context.textBaseline = "middle";
            	// 绘制文字（参数：要写的字，x坐标，y坐标）
            	this.context.fillText(font, 175, 200);
        	}
        },
