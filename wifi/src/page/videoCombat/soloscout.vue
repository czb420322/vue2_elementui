 ...
 * @LastEditTime: 2020-11-02 14:50:10
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \vacp-wfes-v1.7-dev\vacp-wfes\src\page\videoCombat\soloscout.vue
 -->
<template>
 <div class="caseinfo">
    <!-- 头部选项卡 -->
                ...
                <ul class="mainInfo">
                  ...
                  <li>
                    ...
                    <textarea style="resize: none" v-model="caseDescribe" placeholder="请输入简要案情"></textarea>
                     <!-- <div class="mustText mustText3 mustTextDes" v-show="caseDescribeLen">请输入少于100个字符<i></i></div> -->
      ...
      if(this.caseName == ''){
        ...
        .then(response => {
          if(response.data.code == 200){
            // this.$router.push({path:'/casestudy/caseInfomanage/addcasetwo1?menuCode=200', query:{caseUuid:response.data.data.caseUuid,edit:this.edit,hide:false,synergyCombat:this.synergyCombat,showcase:this.showcase}})
