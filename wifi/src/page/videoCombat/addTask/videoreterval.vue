      ...
      <div class="retrimain">
        ...
        <div class="searchtype">
          ...
          <p class="changecolor" @click.capture="changecolor">
            ...
            <i v-show="selectVideo" @click="dialogVisible2 = true;getvideo();">选择视频</i>
            <i @click="openDia">已选视频列表</i>
          </p>
        </div>
        ...
        <div class="reterImg" id="reterimgVideoReterval" @dblclick="getyuan" @click="getcanvas" >
          <img id="imgsVideoReterval" :src="videoImg" alt="">
            ...
            <div class="main1">
              <div class="main1_left" v-show="!checked">
                  <el-tabs type="border-card" @tab-click="handleClick">
                    ...
                    <el-tab-pane>
                        <span slot="label"><i class="el-icon-service"></i>社会面</span>
                        <div class="TreeMain">
                        <span>设备：</span>
                        <el-input v-model="filterText1" placeholder="请输入社会面设备">
                            <!-- <el-button slot="append" icon="el-icon-search" @click="pop">搜索</el-button> -->
                        </el-input>
                        </div>
...
export default {
  ...
  mixins:[copeMapFun,realvideo,beginEnd],
  methods: {
    setName(){
      ...
      this.tastName = Name+year+mouth+day+hour+min+seon+'视频检索'
      console.log(this.tastName);
    },
    //监听树形结构的搜索
    ...
    dianwei(){
      ...
      var imgs = document.getElementById('imgsVideoReterval');
    ...
    dialogvideo () {
      this.$nextTick(()=>{
        ...
        var imgs = document.getElementById('imgsVideoReterval');
        var reterimg = document.getElementById('reterimgVideoReterval');
        document.getElementById('imgsVideoReterval').style.display = 'block';
        imgwh(imgs, reterimg);
    ...
    //获取一个视频
    getCurrentRow(i){
      document.getElementById('imgsVideoReterval').style.display = 'none'
    ...
    getsubmit () {
      ...
      if(point==''){
        layer.alert('请设置检索规则',{icon:2,title:"消息提示"});
        return;
      }
      ...
      let data = {
        task: {
          ...
          taskSearch: {
            category:index,  //点位还是视频
            type: this.retrimodel,  //类型
...
.inputs{
  ...
  .button{
    ...
    padding: 0.2rem 0;
    text-align: center;
    background-color: rgba(12,68,135,0.25);
  }
