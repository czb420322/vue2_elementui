    ...
    <!--<div class="content">-->
      ...
      <transition name="fade">
        <div class="second"  v-show="showSecond" >
          <!--按品牌或者关键字查询型号-->
          <div class="search"><input v-model="searchKey" placeholder="输入品牌下的关键字查询" @keyup.enter="getModelByBrandAndFuzzy" @blur="getModelByBrandAndFuzzy" /> <span class="btn" @click="getModelByBrandAndFuzzy"><i class="el-icon-search"></i></span></div>
          <ul>
