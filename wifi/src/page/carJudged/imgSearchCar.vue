        ...
        <div class="clItem cli1">
          ...
          <ul class="searchCondition">
            ...
            <li v-show="this.isCarHead != 8 && this.isCarHead != 2 && this.isCarHead != 4 && this.isCarHead != 14"><span>车辆类型：</span>
              <el-select type="text" ref="vehicleKind" v-model.trim="vehicleKind" @change="checkVehicleKind" placeholder="请选择车辆类型">
            ...
            <li v-show="this.isCarHead != 8 && this.isCarHead != 2 && this.isCarHead != 4 && this.isCarHead != 14">
              <span>车牌号码：</span>
              <input type="text" ref="plateNumber" v-model.trim="plateNumber" value="不限" minlength="7" maxlength="8" @keyup.enter="checkPlateNumber" @blur="checkPlateNumber" placeholder="请输入车辆号码">
            </li>
