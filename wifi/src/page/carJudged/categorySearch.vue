    ...
    <div class="contentBody">
      ...
      <div class="contentLeft">
        ...
        <div class="clItem cli1">
          <div class="searchTitle"> 按类别搜车</div>
          <ul class="searchCondition">
            ...
            <li v-show="false"><span>抓拍方向：</span>
              <select type="text" ref="isCarHead" v-model="isCarHead"  @change="updateCheckedItem(isCarHead)">
                <option v-for="(item,i) in carHeadList" :key="i" :value="item.value" >{{item.name}}</option>
              </select></li>
            <li v-show="isCarHead!==1"><span><span class="bt">*</span>车辆类型：</span>
            ...
            <li  class="carColorItem">
              <div class="carColor">
                ...
                <div class="choose">
                  ...
                  <selectColor v-show="colorFlag" @sendColorToParent="getColorFromChild"></selectColor>
                </div>
              </div>
            </li>
      ...
      <div class="content">
        ...
        <div class="sDetail" :style="{left: checked?'0.12rem':'100%'}">
          ...
          <search-detail searchType="kind" searchTypePN="kindPN" port="/tvas/kind/query" searchTypeT="kindT" :searchParams="oldParams" :searchResultDefault="searchResultDefault"  :searchResultPlateNo="searchResultPlateNo" :searchResultTollgate="searchResultTollgate"></search-detail>
        </div>
...
<script>
  ...
  export default {
    components: {
      footerThird, searchDetail, selectColor, casDialog
    },
    ...
    changeicoclick(data){
      ...
      getColorFromChild(color) {
        console.log('aaaaaaaaaaaaaaaa'+JSON.stringify(color))
        ...
        //if(this.searchBtn) {
          ...
          this.getVD("kind", params, (res) => {
            ...
            //if(this.searchPNBtn) {
              ...
              this.getVD("kindPN", paramsPN, (res) => {
    ...
    mounted: function () {
      console.log(this.$refs.vehicleKind.value)
      this.getWeekDay();
      this.getTreeData();
      this.getCheckedItem(["vehicleKind","timeType"]);
      let _this = this;
