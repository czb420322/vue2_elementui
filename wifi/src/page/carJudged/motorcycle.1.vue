    ...
    <div class="contentBody">
      ...
      <div class="contentLeft">
        ...
        <div class="clItem cli1">
          <div class="searchTitle">搜非机动车</div>
          <ul class="searchCondition">
            ...
            <li v-show="isCarHead!==1"><span>车辆类型：</span>
              <el-select type="text" ref="vehicleKind" v-model.trim="vehicleKind" placeholder="请选择车辆类型">
            ...
            <li>
              <div class="timeWrap" ref="timeType">
                ...
                <div class="cirTime" v-show="timeFlag" >
                  <input type="text" id="cirYearBegin" readonly v-model.trim="beginDate" placeholder="请选择开始日期"><i class="el-icon-circle-close" @click="clear('beginDate')"></i>
                  <input type="text" id="cirYearEnd" readonly v-model.trim="endDate" placeholder="请选择结束日期"><i class="el-icon-circle-close" @click="clear('endDate')"></i>
                </div>
        ...
        <div class="clItem cli2">
          <div class="map">
            ...
            <div class="mapItem">
              ...
              <div class="itemIcon" @click="toggleBar"></div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        timeType: 0,             //时段类别
        beginDateTime: this.getDateString(new Date().getTime() - 3*24*60*60*1000).split(' ')[0] + " " + "00:00:00", //过车时段开始日期时间
