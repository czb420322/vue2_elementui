...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (res.statusText == "OK" && res.data.code == 200) {
          ...
          for (let i = 0; i < this.vehicleKeyValueList.length; i++) {
            ...
            this.vehicleCountList.push(this.vehicleKeyValueList[i].value);
            // this.percent = true
            // }
          }
    ...
    typeChartPercent() {
      ...
      console.log(currentList.keyValueList,'111');
      let gdata = [];
    ...
    typeChartCount() {
      let myChart = this.$echarts.init(
        document.getElementById("carTypeChartRight"),
        "macarons"
      );
      var dataAxis = this.vehicleClassList;
      var data = this.vehicleCountList;
      ...
      myChart.on("click", function(params) {
        ...
        // console.log(params.dataIndex - zoomSize / 2, 9999);
