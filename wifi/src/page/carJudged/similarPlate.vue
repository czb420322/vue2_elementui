<template>
  <div class="wrapper">
    ...
    <div class="contentBody">
      ...
      <div class="contentLeft">
        ...
        <div class="clItem cli1">
          <div class="searchTitle">相似车牌串并分析</div>
          <ul class="searchCondition">
            ...
            <li class="diffnumber"><span><span class="bt">*</span>相差位数：</span>
              <el-select id="similarSelect" ref="difference" v-model="difference">
                <el-option value="1" label="一位"></el-option>
                <el-option value="2" label="两位"></el-option>
              </el-select></li>
      ...
      <div class="content">
        ...
        <div class="sDetail" :style="{left: checked?'0.12rem':'100%'}">
          ...
          <div class="searchDetailFH">
            <div class="resultTitle">| 相似车牌串并搜索</div>
            ...
            <!--  <table class="resultTable">
                ...
                <tr v-for="(item, index) in searchResult.data.rows">
                  <td>{{(searchResult.data.pageNo-1)*searchResult.data.pageSize+index + 1}}</td>
          ...
          <!--相似车牌列表下某项详细-->
          <car-detail :isShow="showCarDetail" type="similarPlateD" :carParams="currentParams" :carResult="searchResultDetail" @closeCarDetail="closeCarDetail"></car-detail>
        </div>
      </div>
    ...
    <div class="calDialog">
      <casDialog vehicleKind="noKind" :showFirst="showFirst" :showSecond="showSecond" :carBrand="vehicleBrand" :carModel="vehicleModel"  @passToParent="getChildData"
:icoclick="icoclick" @changeicoclick='changeicoclick'></casDialog>
    </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchBtn:this.$storage.getSession("311")!=null?true:false,
        //searchDetailBtn:this.$storage.getSession("355")!=null?true:false,
        map:null,//地图对象
        drawingManager : null,
        overlays:[],
        treeList:null,
        ...
        loading: null,
        similarplateMaxDays: sessionStorage.getItem("similarplateMaxDays"), //可配置时间
    ...
    changeicoclick(data){
      ...
      handleSizeChange(val) {
        ...
        this.getVD("similarPlate", this.oldParams,(res)=>{
      ...
      getCarData (){
        ...
        this.getVD("similarPlate", params3, (res)=>{
          this.transValue(res.data, this.searchResult);
      ...
      getDetail (pId, plateClass,plateClassCode,plateColor,plateColorCode) {
        ...
        this.currentParams = {
          ...
          vehicleModelCode: this.vehicleModelCode,
          difference: this.oldParams.difference,
        ...
        this.getVD("similarPlateD", this.currentParams, (res)=>{
    ...
    mounted: function () {
      ...
      this.timeBegin = laydate.render({
        ...
        btns: ['now','confirm'],
          ...
          let time = Number(_this.similarplateMaxDays)-1;  //可配置时间
