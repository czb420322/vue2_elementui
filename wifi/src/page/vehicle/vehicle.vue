  ...
  export default {
    ...
    methods:{
          ...
          if(res.statusText=="OK" && res.data.code==200){
            ...
            if(this.vehicleClassList.length == 0){
              ...
              this.$nextTick(() => {
                ...
                this.typeChartPercent(pieChartsId);
              });
            }
          }else{
      ...
      typeChartPercent(pieChartsId) {
        ...
        let gdata = [];
        for (let i = 0; i < currentList.keyValueList.length; i++) { //数据转换成highcharts对应的格式
          let idata = [];
            ...
            for (let i = 0; i < this.dataList3.length; i++) {
              ...
              if(this.dataList3[i].plateClass == "" || this.dataList3[i].plateClass == null || this.dataList3[i].vehicleCount =="" || this.dataList3[i].vehicleCount == null){
                ...
                this.vehiclePlateClassList.push({
                  value:this.dataList3[i].vehicleCount,
                  name:this.dataList3[i].plateClass
                })
              }
            }
      ...
      carPlateCount(bargraphId) {
        ...
        console.log(this.vehiclePlateClassList,'hahahah');
        this.getColumnar(bargraphId,gdata,false) //调用封装的柱状图
      },
