  ...
  <div class="dialogWrapper">
    ...
    >
          ...
          <div class="detailItemRight">
            <div class="ownNature">
              ...
              <div class="natureItem">
                <div class="comparePlayBtn">比对播放</div>
              </div>
            </div>
            <div class="othersNature" v-for="(item, index) in compareList"  :key="index">
              ...
              <div class="natureItem" v-text="item.timeLowLimit"></div>
            ...
            <div class="caseListItemTxt">
              ...
              <div class="caseListItemTxtItem">
                <div class="caseListItemTxtItemLeft">
                  ...
                  <div><span class="leftWrods">案发时间:</span> <span v-text="item.timeLowLimit"></span></div>
      ...
      <el-dialog
        ...
        append-to-body>
        <div><span style="width: 60px">案件名称:</span><input type="text"
        ...
        <div style="display: flex;width: 100%;height: 60%;margin-top: 20px">
          ...
          <textarea style="width: calc(100% - 60px);height:120px;border: 1px solid #E8F0F4" placeholder="请输入案件描述"></textarea></div>
...
//添加案件
      ...
      getCompareList() {
        this.$http({
          ...
          method: 'post',
          params: {
            // caseId:this.caseObj.caseUuid,
            caseId: "054DB16696BF4AE5B8A6444DE87FEC3E",
            pageNum: this.pageNo,
      ...
      checkcaseList() {
        //如果案件列表没有案件本身,进行添加
        let hasCaseObj=false
        this.caseList.forEach(item => {
          if(item.caseUuid === this.caseObj.caseUuid){
            hasCaseObj=true
          }
        })
        if(!hasCaseObj){
          this.caseList.push(this.caseObj)
        }
    ...
    computed: {
      dialogVisible: {
        get: function () {
          return this.$store.state.personFaceDialog
        },
        set: function (newVal) {
          this.$store.state.personFaceDialog = newVal
        }
      }
    },
    watch: {
