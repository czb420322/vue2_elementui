 ...
 * @LastEditTime : 2021-08-09 18:50:25
...
<template>
    <div class="manage">
        <!-- <el-button type="primary" @click="testTree">test</el-button> -->
        <keep-alive>
            ...
            <div class="rightcontent">
                ...
                <div class="glaj">
                    ...
                    <div class="aj_info">
                        ...
                        <div class="taskcontent" v-show="tasklist.length > 0">
                             <div
                                class="aj_cont"
    ...
    data() {
        return {
            ...
            cssobj: {
                ...
                702: ["semanticSearch", "/videoStrucPlat/semanticSearch"], //特征搜索
...
.videoRetrieval {
    ...
    transform: translateY(-50%);
    right: .68rem;
    background: url("../../assets/images/VideoStructPlatform/images/retrievalnormal.png")
        no-repeat center / 100% 100%;
}
.videoRetrieval:hover {
    background: url("../../assets/images/VideoStructPlatform/images/retrievalhover.png")
        no-repeat center / 100% 100%;
}
//案件管理
.caseList {
    bottom: .6rem;
    left: 1.55rem;
    background: url("../../assets/images/VideoStructPlatform/images/caseList.png")
        no-repeat center / 100% 100%;
}
.caseList:hover {
    background: url("../../assets/images/VideoStructPlatform/images/caseListhover.png")
        no-repeat center / 100% 100%;
}
...
.MarkPool {
    bottom: .6rem;
    right: 1.55rem;
    background: url("../../assets/images/VideoStructPlatform/images/MarkPool.png")
        no-repeat center / 100% 100%;
}
.MarkPool:hover {
    background: url("../../assets/images/VideoStructPlatform/images/MarkPoolhover.png")
        no-repeat center / 100% 100%;
}
...
.faceManagestruct {
    bottom: 15%;
    right: 1.45rem;
    background: url("../../assets/images/VideoStructPlatform/images/faceManagestruct.png")
        no-repeat center / 100% 100%;
}
.faceManagestruct:hover {
    background: url("../../assets/images/VideoStructPlatform/images/faceManagestructhover.png")
        no-repeat center / 100% 100%;
}
