 ...
 * @LastEditTime : 2020-08-26 11:09:27
...
<template>
   <div class="labelinfo">
    ...
    <div class="searchkline">
      <el-button :disabled="zkyperson" :class="{avtive: iszkyStrucTable == 1}" @click="getpersonInfo" class="commBtn addBtn">行人</el-button>
      <el-button :disabled="zkycar" :class="{avtive: iszkyStrucTable == 2}" @click="getcarInfo" class="commBtn addBtn">车辆</el-button>
      <el-button :disabled="zkybic" :class="{avtive: iszkyStrucTable == 3}" @click="getbicInfo" class="commBtn addBtn">骑车人</el-button>
    </div>
